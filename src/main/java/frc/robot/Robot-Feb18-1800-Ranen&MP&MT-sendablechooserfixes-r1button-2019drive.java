...
public class Robot extends TimedRobot {
    ...
    int openClose = 2; //1 = about to be open (physically closed), 2 = about to be closed (physically open)
    ...
    public void teleopPeriodic() {  // Periodic teleop code (run every (10ms?) while teleop is active)
		...
		if (armGamepad.getRawButton(3) == true) {buttonXPressed = true;} else {buttonXPressed=false;}//Switch mode (X)
