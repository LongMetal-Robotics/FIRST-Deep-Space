...
public class Robot extends TimedRobot {
		// Time to try increasing this a *little*  was quarterVGA 320 wide, 240 high.. consider 512 by 342 or 384 x 256 as middle grounds.. setting to vga 640 x 480
	...
	public SendableChooser<String> robot2019 = new SendableChooser<>();  //SendableChooser for button assignment
    ...
    public void robotInit() {   // Run when robot is turned on. Initialize m.controllers, etc.
		...
		robot2019.setDefaultOption("Major Tom", "MajorTom");
        robot2019.addOption("Low Earth Orbit", "LEO");
        robotSelection = robot2019.getSelected();
        System.out.println(robotSelection);
		SmartDashboard.putString("Robot Selected", robotSelection);
		SmartDashboard.putData("Robot Active", robot2019);
